...
CONTAINS
...
#if __MAX_RANK >= 1
   SUBROUTINE alloc1ds_idp(idp_array, insize, instartidx)
   
      IMPLICIT NONE
      
      INTEGER(KIND=idp), DIMENSION(:), POINTER, INTENT(OUT) :: idp_array
      ...
      NULLIFY(idp_array)
      ALLOCATE(idp_array(startidx: endidx))
      idp_array(:) = 0_idp
      
      RETURN
      
   END SUBROUTINE alloc1ds_idp

   SUBROUTINE alloc1d_idp(idp_array, insize, instartidx)
      ...
      NULLIFY(idp_array)
      ALLOCATE(idp_array(startidx(1): endidx(1)))
      idp_array(:) = 0_idp

      RETURN

   END SUBROUTINE alloc1d_idp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE alloc2d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc2d_idp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE alloc3d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc3d_idp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE alloc4d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc4d_idp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE alloc5d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc5d_idp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE alloc6d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc6d_idp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE alloc7d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc7d_idp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE alloc8d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc8d_idp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE alloc9d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc9d_idp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE alloc10d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc10d_idp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE alloc11d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc11d_idp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE alloc12d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc12d_idp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE alloc13d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc13d_idp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE alloc14d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc14d_idp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE alloc15d_idp(idp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc15d_idp
#endif

#if __MAX_RANK >= 1
   SUBROUTINE realloc1ds_idp(idp_array, newsize, startidx)

      IMPLICIT NONE

      INTEGER(KIND=idp), DIMENSION(:), POINTER, INTENT(INOUT) :: idp_array
      INTEGER, INTENT(IN) :: newsize
      INTEGER, INTENT(IN), OPTIONAL :: startidx

      INTEGER(KIND=idp), DIMENSION(:), POINTER :: tmparray
      ...
      IF (ASSOCIATED(idp_array)) THEN
         oldstartidx = LBOUND(idp_array,1)
         oldendidx =   UBOUND(idp_array,1)
         IF ((newstartidx /= oldstartidx).OR.(newendidx /= oldendidx)) THEN
            ...
            DO i1 = transstartidx, transendidx
               tmparray(i1) = idp_array(i1)
            END DO
            DEALLOCATE(idp_array)
            idp_array => tmparray
         END IF
      ELSE
         ALLOCATE(idp_array(newstartidx: newendidx))
         idp_array(:) = 0_idp
      END IF

      RETURN

   END SUBROUTINE realloc1ds_idp

   SUBROUTINE realloc1d_idp(idp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(idp_array)) THEN
         ...
         END IF
      ELSE
         ALLOCATE(idp_array(newstartidx(1): newendidx(1)))
         idp_array(:) = 0_idp
      END IF

      RETURN

   END SUBROUTINE realloc1d_idp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE realloc2d_idp(idp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(idp_array)) THEN
         oldstartidx = LBOUND(idp_array)
         oldendidx =   UBOUND(idp_array)
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
             (ANY(oldendidx(:) - newendidx(:) /= 0))) THEN
#ifdef __DEBUG_MSG
            WRITE(UNIT=ERROR_UNIT, FMT=*) "Reallocating from [", oldstartidx,",",oldendidx,"]"
            ...
            DO i2 = transstartidx(2), transendidx(2)
               DO i1 = transstartidx(1), transendidx(1)
                  tmparray(i1,i2) = idp_array(i1,i2)
               END DO
            END DO
            DEALLOCATE(idp_array)
            idp_array => tmparray
   ...
   END SUBROUTINE realloc2d_idp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE realloc3d_idp(idp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(idp_array)) THEN
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i3 = transstartidx(3), transendidx(3)
               DO i2 = transstartidx(2), transendidx(2)
                  DO i1 = transstartidx(1), transendidx(1)
                     tmparray(i1,i2,i3) = idp_array(i1,i2,i3)
                  END DO
               END DO
            END DO
            DEALLOCATE(idp_array)
   ...
   END SUBROUTINE realloc3d_idp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE realloc4d_idp(idp_array, newsize, startidx)
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i4 = transstartidx(4), transendidx(4)
               DO i3 = transstartidx(3), transendidx(3)
                  DO i2 = transstartidx(2), transendidx(2)
                     DO i1 = transstartidx(1), transendidx(1)
                        tmparray(i1,i2,i3,i4) = idp_array(i1,i2,i3,i4)
                     END DO
                  END DO
               END DO
            END DO
   ...
   END SUBROUTINE realloc4d_idp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE realloc5d_idp(idp_array, newsize, startidx)
            ...
            DO i5 = transstartidx(5), transendidx(5)
               DO i4 = transstartidx(4), transendidx(4)
                  DO i3 = transstartidx(3), transendidx(3)
                     DO i2 = transstartidx(2), transendidx(2)
                        DO i1 = transstartidx(1), transendidx(1)
                           tmparray(i1,i2,i3,i4,i5) = idp_array(i1,i2,i3,i4,i5)
                        END DO
                     END DO
                  END DO
               END DO
   ...
   END SUBROUTINE realloc5d_idp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE realloc6d_idp(idp_array, newsize, startidx)
               ...
               DO i5 = transstartidx(5), transendidx(5)
                  DO i4 = transstartidx(4), transendidx(4)
                     DO i3 = transstartidx(3), transendidx(3)
                        DO i2 = transstartidx(2), transendidx(2)
                           DO i1 = transstartidx(1), transendidx(1)
                              tmparray(i1,i2,i3,i4,i5,i6) = idp_array(i1,i2,i3,i4,i5,i6)
                           END DO
                        END DO
                     END DO
                  END DO
   ...
   END SUBROUTINE realloc6d_idp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE realloc7d_idp(idp_array, newsize, startidx)
                  ...
                  DO i5 = transstartidx(5), transendidx(5)
                     DO i4 = transstartidx(4), transendidx(4)
                        DO i3 = transstartidx(3), transendidx(3)
                           DO i2 = transstartidx(2), transendidx(2)
                              DO i1 = transstartidx(1), transendidx(1)
                                 tmparray(i1,i2,i3,i4,i5,i6,i7) = idp_array(i1,i2,i3,i4,i5,i6,i7)
                              END DO
                           END DO
                        END DO
                     END DO
   ...
   END SUBROUTINE realloc7d_idp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE realloc8d_idp(idp_array, newsize, startidx)
                     ...
                     DO i5 = transstartidx(5), transendidx(5)
                        DO i4 = transstartidx(4), transendidx(4)
                           DO i3 = transstartidx(3), transendidx(3)
                              DO i2 = transstartidx(2), transendidx(2)
                                 DO i1 = transstartidx(1), transendidx(1)
                                    tmparray(i1,i2,i3,i4,i5,i6,i7,i8) = idp_array(i1,i2,i3,i4,i5,i6,i7,i8)
                                 END DO
                              END DO
                           END DO
                        END DO
   ...
   END SUBROUTINE realloc8d_idp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE realloc9d_idp(idp_array, newsize, startidx)
                        ...
                        DO i5 = transstartidx(5), transendidx(5)
                           DO i4 = transstartidx(4), transendidx(4)
                              DO i3 = transstartidx(3), transendidx(3)
                                 DO i2 = transstartidx(2), transendidx(2)
                                    DO i1 = transstartidx(1), transendidx(1)
                                       tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9) = idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9)
                                    END DO
                                 END DO
                              END DO
                           END DO
   ...
   END SUBROUTINE realloc9d_idp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE realloc10d_idp(idp_array, newsize, startidx)
                                    ...
                                    DO i2 = transstartidx(2), transendidx(2)
                                       DO i1 = transstartidx(1), transendidx(1)
                                          tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10) = &
                                             idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10)
                                       END DO
                                    END DO
                                 END DO
                              END DO
   ...
   END SUBROUTINE realloc10d_idp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE realloc11d_idp(idp_array, newsize, startidx)
                                       ...
                                       DO i2 = transstartidx(2), transendidx(2)
                                          DO i1 = transstartidx(1), transendidx(1)
                                             tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11) = &
                                                idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11)
                                          END DO
                                       END DO
                                    END DO
                                 END DO
   ...
   END SUBROUTINE realloc11d_idp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE realloc12d_idp(idp_array, newsize, startidx)
                                          ...
                                          DO i2 = transstartidx(2), transendidx(2)
                                             DO i1 = transstartidx(1), transendidx(1)
                                                tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12) = &
                                                   idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12)
                                             END DO
                                          END DO
                                       END DO
                                    END DO
   ...
   END SUBROUTINE realloc12d_idp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE realloc13d_idp(idp_array, newsize, startidx)
                                             ...
                                             DO i2 = transstartidx(2), transendidx(2)
                                                DO i1 = transstartidx(1), transendidx(1)
                                                   tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13) = &
                                                      idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13)
                                                END DO
                                             END DO
                                          END DO
                                       END DO
   ...
   END SUBROUTINE realloc13d_idp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE realloc14d_idp(idp_array, newsize, startidx)
                                                ...
                                                DO i2 = transstartidx(2), transendidx(2)
                                                   DO i1 = transstartidx(1), transendidx(1)
                                                      tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14) = &
                                                         idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14)
                                                   END DO
                                                END DO
                                             END DO
                                          END DO
   ...
   END SUBROUTINE realloc14d_idp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE realloc15d_idp(idp_array, newsize, startidx)
                                                   ...
                                                   DO i2 = transstartidx(2), transendidx(2)
                                                      DO i1 = transstartidx(1), transendidx(1)
                                                         tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15) = &
                                                            idp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15)
                                                      END DO
                                                   END DO
                                                END DO
                                             END DO
   ...
   END SUBROUTINE realloc15d_idp
#endif

#if __MAX_RANK >= 1
   SUBROUTINE dealloc1d_idp(idp_array)
   ...
   END SUBROUTINE dealloc1d_idp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE dealloc2d_idp(idp_array)
   ...
   END SUBROUTINE dealloc2d_idp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE dealloc3d_idp(idp_array)
   ...
   END SUBROUTINE dealloc3d_idp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE dealloc4d_idp(idp_array)
   ...
   END SUBROUTINE dealloc4d_idp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE dealloc5d_idp(idp_array)
   ...
   END SUBROUTINE dealloc5d_idp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE dealloc6d_idp(idp_array)
   ...
   END SUBROUTINE dealloc6d_idp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE dealloc7d_idp(idp_array)
   ...
   END SUBROUTINE dealloc7d_idp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE dealloc8d_idp(idp_array)
   ...
   END SUBROUTINE dealloc8d_idp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE dealloc9d_idp(idp_array)
   ...
   END SUBROUTINE dealloc9d_idp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE dealloc10d_idp(idp_array)
   ...
   END SUBROUTINE dealloc10d_idp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE dealloc11d_idp(idp_array)
   ...
   END SUBROUTINE dealloc11d_idp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE dealloc12d_idp(idp_array)
   ...
   END SUBROUTINE dealloc12d_idp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE dealloc13d_idp(idp_array)
   ...
   END SUBROUTINE dealloc13d_idp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE dealloc14d_idp(idp_array)
   ...
   END SUBROUTINE dealloc14d_idp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE dealloc15d_idp(idp_array)
   ...
   END SUBROUTINE dealloc15d_idp
#endif

END MODULE re_de_allocidp
