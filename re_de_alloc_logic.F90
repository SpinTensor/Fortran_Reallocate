...
CONTAINS
...
#if __MAX_RANK >= 1
   SUBROUTINE alloc1ds_logic(logic_array, insize, instartidx)
   
      IMPLICIT NONE
      
      LOGICAL, DIMENSION(:), POINTER, INTENT(OUT) :: logic_array
      ...
      NULLIFY(logic_array)
      ALLOCATE(logic_array(startidx: endidx))
      logic_array(:) = .FALSE.
      
      RETURN
      
   END SUBROUTINE alloc1ds_logic

   SUBROUTINE alloc1d_logic(logic_array, insize, instartidx)
      ...
      NULLIFY(logic_array)
      ALLOCATE(logic_array(startidx(1): endidx(1)))
      logic_array(:) = .FALSE.

      RETURN

   END SUBROUTINE alloc1d_logic
#endif

#if __MAX_RANK >= 2
   SUBROUTINE alloc2d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc2d_logic
#endif

#if __MAX_RANK >= 3
   SUBROUTINE alloc3d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc3d_logic
#endif

#if __MAX_RANK >= 4
   SUBROUTINE alloc4d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc4d_logic
#endif

#if __MAX_RANK >= 5
   SUBROUTINE alloc5d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc5d_logic
#endif

#if __MAX_RANK >= 6
   SUBROUTINE alloc6d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc6d_logic
#endif

#if __MAX_RANK >= 7
   SUBROUTINE alloc7d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc7d_logic
#endif

#if __MAX_RANK >= 8
   SUBROUTINE alloc8d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc8d_logic
#endif

#if __MAX_RANK >= 9
   SUBROUTINE alloc9d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc9d_logic
#endif

#if __MAX_RANK >= 10
   SUBROUTINE alloc10d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc10d_logic
#endif

#if __MAX_RANK >= 11
   SUBROUTINE alloc11d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc11d_logic
#endif

#if __MAX_RANK >= 12
   SUBROUTINE alloc12d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc12d_logic
#endif

#if __MAX_RANK >= 13
   SUBROUTINE alloc13d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc13d_logic
#endif

#if __MAX_RANK >= 14
   SUBROUTINE alloc14d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc14d_logic
#endif

#if __MAX_RANK >= 15
   SUBROUTINE alloc15d_logic(logic_array, insize, instartidx)
   ...
   END SUBROUTINE alloc15d_logic
#endif

#if __MAX_RANK >= 1
   SUBROUTINE realloc1ds_logic(logic_array, newsize, startidx)

      IMPLICIT NONE

      LOGICAL, DIMENSION(:), POINTER, INTENT(INOUT) :: logic_array
      INTEGER, INTENT(IN) :: newsize
      INTEGER, INTENT(IN), OPTIONAL :: startidx

      LOGICAL, DIMENSION(:), POINTER :: tmparray
      ...
      IF (ASSOCIATED(logic_array)) THEN
         oldstartidx = LBOUND(logic_array,1)
         oldendidx =   UBOUND(logic_array,1)
         IF ((newstartidx /= oldstartidx).OR.(newendidx /= oldendidx)) THEN
            ...
            DO i1 = transstartidx, transendidx
               tmparray(i1) = logic_array(i1)
            END DO
            DEALLOCATE(logic_array)
            logic_array => tmparray
         END IF
      ELSE
         ALLOCATE(logic_array(newstartidx: newendidx))
         logic_array(:) = .FALSE.
      END IF

      RETURN

   END SUBROUTINE realloc1ds_logic

   SUBROUTINE realloc1d_logic(logic_array, newsize, startidx)
      ...
      IF (ASSOCIATED(logic_array)) THEN
         ...
         END IF
      ELSE
         ALLOCATE(logic_array(newstartidx(1): newendidx(1)))
         logic_array(:) = .FALSE.
      END IF

      RETURN

   END SUBROUTINE realloc1d_logic
#endif

#if __MAX_RANK >= 2
   SUBROUTINE realloc2d_logic(logic_array, newsize, startidx)
      ...
      IF (ASSOCIATED(logic_array)) THEN
         oldstartidx = LBOUND(logic_array)
         oldendidx =   UBOUND(logic_array)
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
             (ANY(oldendidx(:) - newendidx(:) /= 0))) THEN
#ifdef __DEBUG_MSG
            WRITE(UNIT=ERROR_UNIT, FMT=*) "Reallocating from [", oldstartidx,",",oldendidx,"]"
            ...
            DO i2 = transstartidx(2), transendidx(2)
               DO i1 = transstartidx(1), transendidx(1)
                  tmparray(i1,i2) = logic_array(i1,i2)
               END DO
            END DO
            DEALLOCATE(logic_array)
            logic_array => tmparray
   ...
   END SUBROUTINE realloc2d_logic
#endif

#if __MAX_RANK >= 3
   SUBROUTINE realloc3d_logic(logic_array, newsize, startidx)
      ...
      IF (ASSOCIATED(logic_array)) THEN
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i3 = transstartidx(3), transendidx(3)
               DO i2 = transstartidx(2), transendidx(2)
                  DO i1 = transstartidx(1), transendidx(1)
                     tmparray(i1,i2,i3) = logic_array(i1,i2,i3)
                  END DO
               END DO
            END DO
            DEALLOCATE(logic_array)
   ...
   END SUBROUTINE realloc3d_logic
#endif

#if __MAX_RANK >= 4
   SUBROUTINE realloc4d_logic(logic_array, newsize, startidx)
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i4 = transstartidx(4), transendidx(4)
               DO i3 = transstartidx(3), transendidx(3)
                  DO i2 = transstartidx(2), transendidx(2)
                     DO i1 = transstartidx(1), transendidx(1)
                        tmparray(i1,i2,i3,i4) = logic_array(i1,i2,i3,i4)
                     END DO
                  END DO
               END DO
            END DO
   ...
   END SUBROUTINE realloc4d_logic
#endif

#if __MAX_RANK >= 5
   SUBROUTINE realloc5d_logic(logic_array, newsize, startidx)
            ...
            DO i5 = transstartidx(5), transendidx(5)
               DO i4 = transstartidx(4), transendidx(4)
                  DO i3 = transstartidx(3), transendidx(3)
                     DO i2 = transstartidx(2), transendidx(2)
                        DO i1 = transstartidx(1), transendidx(1)
                           tmparray(i1,i2,i3,i4,i5) = logic_array(i1,i2,i3,i4,i5)
                        END DO
                     END DO
                  END DO
               END DO
   ...
   END SUBROUTINE realloc5d_logic
#endif

#if __MAX_RANK >= 6
   SUBROUTINE realloc6d_logic(logic_array, newsize, startidx)
               ...
               DO i5 = transstartidx(5), transendidx(5)
                  DO i4 = transstartidx(4), transendidx(4)
                     DO i3 = transstartidx(3), transendidx(3)
                        DO i2 = transstartidx(2), transendidx(2)
                           DO i1 = transstartidx(1), transendidx(1)
                              tmparray(i1,i2,i3,i4,i5,i6) = logic_array(i1,i2,i3,i4,i5,i6)
                           END DO
                        END DO
                     END DO
                  END DO
   ...
   END SUBROUTINE realloc6d_logic
#endif

#if __MAX_RANK >= 7
   SUBROUTINE realloc7d_logic(logic_array, newsize, startidx)
                  ...
                  DO i5 = transstartidx(5), transendidx(5)
                     DO i4 = transstartidx(4), transendidx(4)
                        DO i3 = transstartidx(3), transendidx(3)
                           DO i2 = transstartidx(2), transendidx(2)
                              DO i1 = transstartidx(1), transendidx(1)
                                 tmparray(i1,i2,i3,i4,i5,i6,i7) = logic_array(i1,i2,i3,i4,i5,i6,i7)
                              END DO
                           END DO
                        END DO
                     END DO
   ...
   END SUBROUTINE realloc7d_logic
#endif

#if __MAX_RANK >= 8
   SUBROUTINE realloc8d_logic(logic_array, newsize, startidx)
                     ...
                     DO i5 = transstartidx(5), transendidx(5)
                        DO i4 = transstartidx(4), transendidx(4)
                           DO i3 = transstartidx(3), transendidx(3)
                              DO i2 = transstartidx(2), transendidx(2)
                                 DO i1 = transstartidx(1), transendidx(1)
                                    tmparray(i1,i2,i3,i4,i5,i6,i7,i8) = logic_array(i1,i2,i3,i4,i5,i6,i7,i8)
                                 END DO
                              END DO
                           END DO
                        END DO
   ...
   END SUBROUTINE realloc8d_logic
#endif

#if __MAX_RANK >= 9
   SUBROUTINE realloc9d_logic(logic_array, newsize, startidx)
                        ...
                        DO i5 = transstartidx(5), transendidx(5)
                           DO i4 = transstartidx(4), transendidx(4)
                              DO i3 = transstartidx(3), transendidx(3)
                                 DO i2 = transstartidx(2), transendidx(2)
                                    DO i1 = transstartidx(1), transendidx(1)
                                       tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9) = logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9)
                                    END DO
                                 END DO
                              END DO
                           END DO
   ...
   END SUBROUTINE realloc9d_logic
#endif

#if __MAX_RANK >= 10
   SUBROUTINE realloc10d_logic(logic_array, newsize, startidx)
                                    ...
                                    DO i2 = transstartidx(2), transendidx(2)
                                       DO i1 = transstartidx(1), transendidx(1)
                                          tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10) = &
                                             logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10)
                                       END DO
                                    END DO
                                 END DO
                              END DO
   ...
   END SUBROUTINE realloc10d_logic
#endif

#if __MAX_RANK >= 11
   SUBROUTINE realloc11d_logic(logic_array, newsize, startidx)
                                       ...
                                       DO i2 = transstartidx(2), transendidx(2)
                                          DO i1 = transstartidx(1), transendidx(1)
                                             tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11) = &
                                                logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11)
                                          END DO
                                       END DO
                                    END DO
                                 END DO
   ...
   END SUBROUTINE realloc11d_logic
#endif

#if __MAX_RANK >= 12
   SUBROUTINE realloc12d_logic(logic_array, newsize, startidx)
                                          ...
                                          DO i2 = transstartidx(2), transendidx(2)
                                             DO i1 = transstartidx(1), transendidx(1)
                                                tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12) = &
                                                   logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12)
                                             END DO
                                          END DO
                                       END DO
                                    END DO
   ...
   END SUBROUTINE realloc12d_logic
#endif

#if __MAX_RANK >= 13
   SUBROUTINE realloc13d_logic(logic_array, newsize, startidx)
                                             ...
                                             DO i2 = transstartidx(2), transendidx(2)
                                                DO i1 = transstartidx(1), transendidx(1)
                                                   tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13) = &
                                                      logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13)
                                                END DO
                                             END DO
                                          END DO
                                       END DO
   ...
   END SUBROUTINE realloc13d_logic
#endif

#if __MAX_RANK >= 14
   SUBROUTINE realloc14d_logic(logic_array, newsize, startidx)
                                                ...
                                                DO i2 = transstartidx(2), transendidx(2)
                                                   DO i1 = transstartidx(1), transendidx(1)
                                                      tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14) = &
                                                         logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14)
                                                   END DO
                                                END DO
                                             END DO
                                          END DO
   ...
   END SUBROUTINE realloc14d_logic
#endif

#if __MAX_RANK >= 15
   SUBROUTINE realloc15d_logic(logic_array, newsize, startidx)
                                                   ...
                                                   DO i2 = transstartidx(2), transendidx(2)
                                                      DO i1 = transstartidx(1), transendidx(1)
                                                         tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15) = &
                                                            logic_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15)
                                                      END DO
                                                   END DO
                                                END DO
                                             END DO
   ...
   END SUBROUTINE realloc15d_logic
#endif

#if __MAX_RANK >= 1
   SUBROUTINE dealloc1d_logic(logic_array)
   ...
   END SUBROUTINE dealloc1d_logic
#endif

#if __MAX_RANK >= 2
   SUBROUTINE dealloc2d_logic(logic_array)
   ...
   END SUBROUTINE dealloc2d_logic
#endif

#if __MAX_RANK >= 3
   SUBROUTINE dealloc3d_logic(logic_array)
   ...
   END SUBROUTINE dealloc3d_logic
#endif

#if __MAX_RANK >= 4
   SUBROUTINE dealloc4d_logic(logic_array)
   ...
   END SUBROUTINE dealloc4d_logic
#endif

#if __MAX_RANK >= 5
   SUBROUTINE dealloc5d_logic(logic_array)
   ...
   END SUBROUTINE dealloc5d_logic
#endif

#if __MAX_RANK >= 6
   SUBROUTINE dealloc6d_logic(logic_array)
   ...
   END SUBROUTINE dealloc6d_logic
#endif

#if __MAX_RANK >= 7
   SUBROUTINE dealloc7d_logic(logic_array)
   ...
   END SUBROUTINE dealloc7d_logic
#endif

#if __MAX_RANK >= 8
   SUBROUTINE dealloc8d_logic(logic_array)
   ...
   END SUBROUTINE dealloc8d_logic
#endif

#if __MAX_RANK >= 9
   SUBROUTINE dealloc9d_logic(logic_array)
   ...
   END SUBROUTINE dealloc9d_logic
#endif

#if __MAX_RANK >= 10
   SUBROUTINE dealloc10d_logic(logic_array)
   ...
   END SUBROUTINE dealloc10d_logic
#endif

#if __MAX_RANK >= 11
   SUBROUTINE dealloc11d_logic(logic_array)
   ...
   END SUBROUTINE dealloc11d_logic
#endif

#if __MAX_RANK >= 12
   SUBROUTINE dealloc12d_logic(logic_array)
   ...
   END SUBROUTINE dealloc12d_logic
#endif

#if __MAX_RANK >= 13
   SUBROUTINE dealloc13d_logic(logic_array)
   ...
   END SUBROUTINE dealloc13d_logic
#endif

#if __MAX_RANK >= 14
   SUBROUTINE dealloc14d_logic(logic_array)
   ...
   END SUBROUTINE dealloc14d_logic
#endif

#if __MAX_RANK >= 15
   SUBROUTINE dealloc15d_logic(logic_array)
   ...
   END SUBROUTINE dealloc15d_logic
#endif

END MODULE re_de_alloclogic
