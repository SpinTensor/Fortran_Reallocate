...
CONTAINS
...
#if __MAX_RANK >= 1
   SUBROUTINE alloc1ds_sp(sp_array, insize, instartidx)
   
      IMPLICIT NONE
      
      REAL(KIND=sp), DIMENSION(:), POINTER, INTENT(OUT) :: sp_array
      ...
      NULLIFY(sp_array)
      ALLOCATE(sp_array(startidx: endidx))
      sp_array(:) = 0.0_sp
      
      RETURN
      
   END SUBROUTINE alloc1ds_sp

   SUBROUTINE alloc1d_sp(sp_array, insize, instartidx)
      ...
      NULLIFY(sp_array)
      ALLOCATE(sp_array(startidx(1): endidx(1)))
      sp_array(:) = 0.0_sp

      RETURN

   END SUBROUTINE alloc1d_sp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE alloc2d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc2d_sp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE alloc3d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc3d_sp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE alloc4d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc4d_sp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE alloc5d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc5d_sp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE alloc6d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc6d_sp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE alloc7d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc7d_sp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE alloc8d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc8d_sp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE alloc9d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc9d_sp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE alloc10d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc10d_sp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE alloc11d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc11d_sp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE alloc12d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc12d_sp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE alloc13d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc13d_sp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE alloc14d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc14d_sp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE alloc15d_sp(sp_array, insize, instartidx)
   ...
   END SUBROUTINE alloc15d_sp
#endif

#if __MAX_RANK >= 1
   SUBROUTINE realloc1ds_sp(sp_array, newsize, startidx)

      IMPLICIT NONE

      REAL(KIND=sp), DIMENSION(:), POINTER, INTENT(INOUT) :: sp_array
      INTEGER, INTENT(IN) :: newsize
      INTEGER, INTENT(IN), OPTIONAL :: startidx

      REAL(KIND=sp), DIMENSION(:), POINTER :: tmparray
      ...
      IF (ASSOCIATED(sp_array)) THEN
         oldstartidx = LBOUND(sp_array,1)
         oldendidx =   UBOUND(sp_array,1)
         IF ((newstartidx /= oldstartidx).OR.(newendidx /= oldendidx)) THEN
            ...
            DO i1 = transstartidx, transendidx
               tmparray(i1) = sp_array(i1)
            END DO
            DEALLOCATE(sp_array)
            sp_array => tmparray
         END IF
      ELSE
         ALLOCATE(sp_array(newstartidx: newendidx))
         sp_array(:) = 0.0_sp
      END IF

      RETURN

   END SUBROUTINE realloc1ds_sp

   SUBROUTINE realloc1d_sp(sp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(sp_array)) THEN
         ...
         END IF
      ELSE
         ALLOCATE(sp_array(newstartidx(1): newendidx(1)))
         sp_array(:) = 0.0_sp
      END IF

      RETURN

   END SUBROUTINE realloc1d_sp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE realloc2d_sp(sp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(sp_array)) THEN
         oldstartidx = LBOUND(sp_array)
         oldendidx =   UBOUND(sp_array)
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
             (ANY(oldendidx(:) - newendidx(:) /= 0))) THEN
#ifdef __DEBUG_MSG
            WRITE(UNIT=ERROR_UNIT, FMT=*) "Reallocating from [", oldstartidx,",",oldendidx,"]"
   ...
   END SUBROUTINE realloc2d_sp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE realloc3d_sp(sp_array, newsize, startidx)
      ...
      IF (ASSOCIATED(sp_array)) THEN
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i3 = transstartidx(3), transendidx(3)
               DO i2 = transstartidx(2), transendidx(2)
                  DO i1 = transstartidx(1), transendidx(1)
                     tmparray(i1,i2,i3) = sp_array(i1,i2,i3)
                  END DO
               END DO
            END DO
            DEALLOCATE(sp_array)
   ...
   END SUBROUTINE realloc3d_sp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE realloc4d_sp(sp_array, newsize, startidx)
         ...
         IF ((ANY(oldstartidx(:) - newstartidx(:) /= 0)).OR. &
            ...
            DO i4 = transstartidx(4), transendidx(4)
               DO i3 = transstartidx(3), transendidx(3)
                  DO i2 = transstartidx(2), transendidx(2)
                     DO i1 = transstartidx(1), transendidx(1)
                        tmparray(i1,i2,i3,i4) = sp_array(i1,i2,i3,i4)
                     END DO
                  END DO
               END DO
            END DO
   ...
   END SUBROUTINE realloc4d_sp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE realloc5d_sp(sp_array, newsize, startidx)
            ...
            DO i5 = transstartidx(5), transendidx(5)
               DO i4 = transstartidx(4), transendidx(4)
                  DO i3 = transstartidx(3), transendidx(3)
                     DO i2 = transstartidx(2), transendidx(2)
                        DO i1 = transstartidx(1), transendidx(1)
                           tmparray(i1,i2,i3,i4,i5) = sp_array(i1,i2,i3,i4,i5)
                        END DO
                     END DO
                  END DO
               END DO
   ...
   END SUBROUTINE realloc5d_sp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE realloc6d_sp(sp_array, newsize, startidx)
               ...
               DO i5 = transstartidx(5), transendidx(5)
                  DO i4 = transstartidx(4), transendidx(4)
                     DO i3 = transstartidx(3), transendidx(3)
                        DO i2 = transstartidx(2), transendidx(2)
                           DO i1 = transstartidx(1), transendidx(1)
                              tmparray(i1,i2,i3,i4,i5,i6) = sp_array(i1,i2,i3,i4,i5,i6)
                           END DO
                        END DO
                     END DO
                  END DO
   ...
   END SUBROUTINE realloc6d_sp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE realloc7d_sp(sp_array, newsize, startidx)
                  ...
                  DO i5 = transstartidx(5), transendidx(5)
                     DO i4 = transstartidx(4), transendidx(4)
                        DO i3 = transstartidx(3), transendidx(3)
                           DO i2 = transstartidx(2), transendidx(2)
                              DO i1 = transstartidx(1), transendidx(1)
                                 tmparray(i1,i2,i3,i4,i5,i6,i7) = sp_array(i1,i2,i3,i4,i5,i6,i7)
                              END DO
                           END DO
                        END DO
                     END DO
   ...
   END SUBROUTINE realloc7d_sp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE realloc8d_sp(sp_array, newsize, startidx)
                     ...
                     DO i5 = transstartidx(5), transendidx(5)
                        DO i4 = transstartidx(4), transendidx(4)
                           DO i3 = transstartidx(3), transendidx(3)
                              DO i2 = transstartidx(2), transendidx(2)
                                 DO i1 = transstartidx(1), transendidx(1)
                                    tmparray(i1,i2,i3,i4,i5,i6,i7,i8) = sp_array(i1,i2,i3,i4,i5,i6,i7,i8)
                                 END DO
                              END DO
                           END DO
                        END DO
   ...
   END SUBROUTINE realloc8d_sp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE realloc9d_sp(sp_array, newsize, startidx)
                        ...
                        DO i5 = transstartidx(5), transendidx(5)
                           DO i4 = transstartidx(4), transendidx(4)
                              DO i3 = transstartidx(3), transendidx(3)
                                 DO i2 = transstartidx(2), transendidx(2)
                                    DO i1 = transstartidx(1), transendidx(1)
                                       tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9) = sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9)
                                    END DO
                                 END DO
                              END DO
                           END DO
   ...
   END SUBROUTINE realloc9d_sp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE realloc10d_sp(sp_array, newsize, startidx)
                                    ...
                                    DO i2 = transstartidx(2), transendidx(2)
                                       DO i1 = transstartidx(1), transendidx(1)
                                          tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10) = &
                                             sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10)
                                       END DO
                                    END DO
                                 END DO
                              END DO
   ...
   END SUBROUTINE realloc10d_sp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE realloc11d_sp(sp_array, newsize, startidx)
                                       ...
                                       DO i2 = transstartidx(2), transendidx(2)
                                          DO i1 = transstartidx(1), transendidx(1)
                                             tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11) = &
                                                sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11)
                                          END DO
                                       END DO
                                    END DO
                                 END DO
   ...
   END SUBROUTINE realloc11d_sp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE realloc12d_sp(sp_array, newsize, startidx)
                                          ...
                                          DO i2 = transstartidx(2), transendidx(2)
                                             DO i1 = transstartidx(1), transendidx(1)
                                                tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12) = &
                                                   sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12)
                                             END DO
                                          END DO
                                       END DO
                                    END DO
   ...
   END SUBROUTINE realloc12d_sp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE realloc13d_sp(sp_array, newsize, startidx)
                                             ...
                                             DO i2 = transstartidx(2), transendidx(2)
                                                DO i1 = transstartidx(1), transendidx(1)
                                                   tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13) = &
                                                      sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13)
                                                END DO
                                             END DO
                                          END DO
                                       END DO
   ...
   END SUBROUTINE realloc13d_sp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE realloc14d_sp(sp_array, newsize, startidx)
                                                ...
                                                DO i2 = transstartidx(2), transendidx(2)
                                                   DO i1 = transstartidx(1), transendidx(1)
                                                      tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14) = &
                                                         sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14)
                                                   END DO
                                                END DO
                                             END DO
                                          END DO
   ...
   END SUBROUTINE realloc14d_sp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE realloc15d_sp(sp_array, newsize, startidx)
                                                   ...
                                                   DO i2 = transstartidx(2), transendidx(2)
                                                      DO i1 = transstartidx(1), transendidx(1)
                                                         tmparray(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15) = &
                                                            sp_array(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15)
                                                      END DO
                                                   END DO
                                                END DO
                                             END DO
   ...
   END SUBROUTINE realloc15d_sp
#endif

#if __MAX_RANK >= 1
   SUBROUTINE dealloc1d_sp(sp_array)
   ...
   END SUBROUTINE dealloc1d_sp
#endif

#if __MAX_RANK >= 2
   SUBROUTINE dealloc2d_sp(sp_array)
   ...
   END SUBROUTINE dealloc2d_sp
#endif

#if __MAX_RANK >= 3
   SUBROUTINE dealloc3d_sp(sp_array)
   ...
   END SUBROUTINE dealloc3d_sp
#endif

#if __MAX_RANK >= 4
   SUBROUTINE dealloc4d_sp(sp_array)
   ...
   END SUBROUTINE dealloc4d_sp
#endif

#if __MAX_RANK >= 5
   SUBROUTINE dealloc5d_sp(sp_array)
   ...
   END SUBROUTINE dealloc5d_sp
#endif

#if __MAX_RANK >= 6
   SUBROUTINE dealloc6d_sp(sp_array)
   ...
   END SUBROUTINE dealloc6d_sp
#endif

#if __MAX_RANK >= 7
   SUBROUTINE dealloc7d_sp(sp_array)
   ...
   END SUBROUTINE dealloc7d_sp
#endif

#if __MAX_RANK >= 8
   SUBROUTINE dealloc8d_sp(sp_array)
   ...
   END SUBROUTINE dealloc8d_sp
#endif

#if __MAX_RANK >= 9
   SUBROUTINE dealloc9d_sp(sp_array)
   ...
   END SUBROUTINE dealloc9d_sp
#endif

#if __MAX_RANK >= 10
   SUBROUTINE dealloc10d_sp(sp_array)
   ...
   END SUBROUTINE dealloc10d_sp
#endif

#if __MAX_RANK >= 11
   SUBROUTINE dealloc11d_sp(sp_array)
   ...
   END SUBROUTINE dealloc11d_sp
#endif

#if __MAX_RANK >= 12
   SUBROUTINE dealloc12d_sp(sp_array)
   ...
   END SUBROUTINE dealloc12d_sp
#endif

#if __MAX_RANK >= 13
   SUBROUTINE dealloc13d_sp(sp_array)
   ...
   END SUBROUTINE dealloc13d_sp
#endif

#if __MAX_RANK >= 14
   SUBROUTINE dealloc14d_sp(sp_array)
   ...
   END SUBROUTINE dealloc14d_sp
#endif

#if __MAX_RANK >= 15
   SUBROUTINE dealloc15d_sp(sp_array)
   ...
   END SUBROUTINE dealloc15d_sp
#endif

END MODULE re_de_allocsp
