PROGRAM test_re_de_alloc_cdp
...
#if __MAX_RANK >= 1
   COMPLEX(KIND=cdp), DIMENSION(:), POINTER :: array_1d
#if __MAX_RANK >= 2
   COMPLEX(KIND=cdp), DIMENSION(:,:), POINTER :: array_2d
#if __MAX_RANK >= 3
   COMPLEX(KIND=cdp), DIMENSION(:,:,:), POINTER :: array_3d
#if __MAX_RANK >= 4
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:), POINTER :: array_4d
#if __MAX_RANK >= 5
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:), POINTER :: array_5d
#if __MAX_RANK >= 6
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:), POINTER :: array_6d
#if __MAX_RANK >= 7
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:), POINTER :: array_7d
#if __MAX_RANK >= 8
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:), POINTER :: array_8d
#if __MAX_RANK >= 9
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:), POINTER :: array_9d
#if __MAX_RANK >= 10
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:), POINTER :: array_10d
#if __MAX_RANK >= 11
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_11d
#if __MAX_RANK >= 12
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_12d
#if __MAX_RANK >= 13
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_13d
#if __MAX_RANK >= 14
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_14d
#if __MAX_RANK >= 15
   COMPLEX(KIND=cdp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_15d
#endif
#endif
#endif
#endif
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc1d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc1d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc2d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc2d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc3d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc3d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc4d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc4d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc5d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc5d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc6d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc6d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc7d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc7d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc8d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc8d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc9d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc9d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc10d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc10d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc11d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc11d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc12d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc12d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc13d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc13d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc14d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc14d_cdp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc15d_cdp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc15d_cdp of module re_de_alloc"
      END IF
   END IF
...
END PROGRAM test_re_de_alloc_cdp
