PROGRAM test_re_de_alloc_sp
...
#if __MAX_RANK >= 1
   REAL(KIND=sp), DIMENSION(:), POINTER :: array_1d
#if __MAX_RANK >= 2
   REAL(KIND=sp), DIMENSION(:,:), POINTER :: array_2d
#if __MAX_RANK >= 3
   REAL(KIND=sp), DIMENSION(:,:,:), POINTER :: array_3d
#if __MAX_RANK >= 4
   REAL(KIND=sp), DIMENSION(:,:,:,:), POINTER :: array_4d
#if __MAX_RANK >= 5
   REAL(KIND=sp), DIMENSION(:,:,:,:,:), POINTER :: array_5d
#if __MAX_RANK >= 6
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:), POINTER :: array_6d
#if __MAX_RANK >= 7
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:), POINTER :: array_7d
#if __MAX_RANK >= 8
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:), POINTER :: array_8d
#if __MAX_RANK >= 9
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:), POINTER :: array_9d
#if __MAX_RANK >= 10
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:), POINTER :: array_10d
#if __MAX_RANK >= 11
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_11d
#if __MAX_RANK >= 12
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_12d
#if __MAX_RANK >= 13
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_13d
#if __MAX_RANK >= 14
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_14d
#if __MAX_RANK >= 15
   REAL(KIND=sp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_15d
#endif
#endif
#endif
#endif
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc1d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc1d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc2d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc2d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc3d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc3d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc4d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc4d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc5d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc5d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc6d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc6d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc7d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc7d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc8d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc8d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc9d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc9d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc10d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc10d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc11d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc11d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc12d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc12d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc13d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc13d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc14d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc14d_sp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc15d_sp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc15d_sp of module re_de_alloc"
      END IF
   END IF
...
END PROGRAM test_re_de_alloc_sp
