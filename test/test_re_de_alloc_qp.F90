PROGRAM test_re_de_alloc_qp
...
#if __MAX_RANK >= 1
   REAL(KIND=qp), DIMENSION(:), POINTER :: array_1d
#if __MAX_RANK >= 2
   REAL(KIND=qp), DIMENSION(:,:), POINTER :: array_2d
#if __MAX_RANK >= 3
   REAL(KIND=qp), DIMENSION(:,:,:), POINTER :: array_3d
#if __MAX_RANK >= 4
   REAL(KIND=qp), DIMENSION(:,:,:,:), POINTER :: array_4d
#if __MAX_RANK >= 5
   REAL(KIND=qp), DIMENSION(:,:,:,:,:), POINTER :: array_5d
#if __MAX_RANK >= 6
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:), POINTER :: array_6d
#if __MAX_RANK >= 7
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:), POINTER :: array_7d
#if __MAX_RANK >= 8
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:), POINTER :: array_8d
#if __MAX_RANK >= 9
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:), POINTER :: array_9d
#if __MAX_RANK >= 10
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:), POINTER :: array_10d
#if __MAX_RANK >= 11
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_11d
#if __MAX_RANK >= 12
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_12d
#if __MAX_RANK >= 13
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_13d
#if __MAX_RANK >= 14
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_14d
#if __MAX_RANK >= 15
   REAL(KIND=qp), DIMENSION(:,:,:,:,:,:,:,:,:,:,:,:,:,:,:), POINTER :: array_15d
#endif
#endif
#endif
#endif
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc1d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc1d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc2d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc2d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc3d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc3d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc4d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc4d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc5d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc5d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc6d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc6d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc7d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc7d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc8d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc8d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc9d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc9d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc10d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc10d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc11d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc11d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc12d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc12d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc13d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc13d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc14d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc14d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine alloc15d_qp of module re_de_alloc"
      END IF
      ...
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine realloc15d_qp of module re_de_alloc"
      END IF
   END IF
   ...
   END IF
#else
   WRITE(UNIT=OUTPUT_UNIT, FMT="(A60)") "Quadruple REAL not supported! Set __HAS_QP to enable!"
#endif
   
END PROGRAM test_re_de_alloc_qp
